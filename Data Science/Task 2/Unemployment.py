...
data = pd.read_csv("D:\\Oasis\\Data Science\\Unemployment\\Unemployment in India.csv")
...
aggregated_data = data.groupby(["Region", "States"], as_index=False)["Estimated Unemployment Rate (%)"].mean()
